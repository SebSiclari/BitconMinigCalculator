    ...
    <SafeAreaView style={globalStyles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.card}>
          ...
          <ResultRow
            label="Revenue"
            value={calculationResults.dailyRevenueUSD}
            isUSD
          />
          <ResultRow label="Cost" value={calculationResults.dailyCost} isUSD />
          <ResultRow
            label="Profit"
            value={calculationResults.dailyProfitUSD}
            isUSD
          />
          <ResultRow
            label="BTC Mined"
            value={calculationResults.dailyRevenueBTC}
            isBTC
          />
        </View>
        ...
        <View style={styles.card}>
          ...
          <ResultRow
            label="Revenue"
            value={calculationResults.monthlyRevenueUSD}
            isUSD
          />
          <ResultRow
            label="Cost"
            value={calculationResults.monthlyCost}
            isUSD
          />
          <ResultRow
            label="Profit"
            value={calculationResults.monthlyProfitUSD}
            isUSD
          />
          <ResultRow
            label="BTC Mined"
            value={calculationResults.monthlyRevenueBTC}
            isBTC
          />
        </View>
        ...
        <View style={styles.card}>
          ...
          <ResultRow
            label="Revenue"
            value={calculationResults.yearlyRevenueUSD}
            isUSD
          />
          <ResultRow label="Cost" value={calculationResults.yearlyCost} isUSD />
          <ResultRow
            label="Profit"
            value={calculationResults.yearlyProfitUSD}
            isUSD
          />
          <ResultRow
            label="BTC Mined"
            value={calculationResults.yearlyRevenueBTC}
            isBTC
          />
        </View>
