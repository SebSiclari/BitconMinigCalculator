...
export const HomeScreen = () => {
  ...
  const validateInputs = () => {
    ...
    if (
      ...
      isNaN(Number(inputs.initial_investment))
    ) {
      ...
      <View style={styles.content}>
        ...
        <View style={globalStyles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={text =>
              setInputs({...inputs, power_consumption: text})
            }
          />
        ...
        <View style={globalStyles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={text =>
              setInputs({...inputs, electricity_cost: text})
            }
          />
        ...
        <View style={globalStyles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={text =>
              setInputs({...inputs, initial_investment: text})
            }
          />
